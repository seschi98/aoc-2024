...
public class Day07Part2 extends PuzzleSolver {

    public static final long EXPECTED = 11387;
    ...
    private boolean equasionIsRight(Long test, List<Long> numbers, Long acc) {
        ...
        return equasionIsRight(test, numbers.subList(1, numbers.size()), acc + numbers.getFirst())
                ...
                || equasionIsRight(test, numbers.subList(1, numbers.size()), Long.valueOf(acc.toString() + numbers.getFirst().toString()));
    }
    ...
    public static void main(String[] args) {
        System.out.println(new Day07Part2().solve());
    }
